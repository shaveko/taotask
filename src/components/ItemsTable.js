...
export default class ItemsTable extends React.Component{
    ...
    render() {
        return <table aria-describedby="headerText" role="table" aria-rowcount={this.props.items?this.props.items.length:0}>
                    
                    <TableHeading columnConfig={this.props.columnConfig}/>
                    <TableBody columnConfig={this.props.columnConfig} items={this.props.items}/>
                </table>
    }  
}
