...
function App() {
  let userColumnConfigApi = [{key: 'firstName', label: 'First Name'}, {key: 'lastName', label: 'Last Name'},]
  ...
  return (
    <div className="App">
      <ListComponent dataProvider={ApiUserDataProvider} columnConfig={userColumnConfigApi}  header={"List of Users"}/>
      {/*
